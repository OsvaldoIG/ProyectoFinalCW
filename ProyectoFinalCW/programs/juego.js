$(document).ready(function(){	
	var barcos=0;
	do
		var barcoTamaño = prompt("Ingresa el tamaño del barco","S: Pequeño   M: Mediano   L: Grande   X: Extra Grande");
	while(barcoTamaño != 's' && barcoTamaño != 'm' && barcoTamaño != 'l' && barcoTamaño != 'x');
	...
	{*/
		switch(barcoTamaño)
		{
			case "s":
				...
				var posicion = prompt("Ingresa el numero de la direccion de tu barco","1: DERECHA   2:IZQUIERDA   3:ABAJO   4:ARRIBA")
				switch(posicion)
				{
					case "1":
						//DERECHA
