<!DOCTYPE html>
                  		...
                  		for($printpub=$cuenta;$printpub>=1;$printpub--)
                      {
                    			...
                    			while($filac)
                    			{
                    			  ...
                    			  echo "<div id='infousuco".$filap["id_publicacion"]."' style='background-color:#8c8c8c;'></div>
                    				...
                    				<a href='reportes.html'><button class='reporte btn waves-effect waves-light btn_large red' type='submit' name='repo'>REPORTAR PUBLICACION<i class='material-icons right'>warning</i></button></a>
                    				</center>
                    				<input type='text' name='come' id='come".$filap["id_publicacion"]."' placeholder='ENP'>
                    				<button id='botco".$filap["id_publicacion"]."' class='btn waves-effect waves-light btn_large blue darken-4' type='submit' name='come'>COMENTAR<i class='material-icons left'>list</i></button><br/><br/>";
 ...
 <footer class="page-footer #283593 indigo darken-3">
    ...
    <div class="footer-copyright">
	 ...
	 <script type="text/javascript" src="../programs/publicaciones.js"></script>
   </body>
 </html>
